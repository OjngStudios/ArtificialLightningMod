 ...
 *
 *    Keep the ElementsArtificialLightningMod object in this class and all calls to this object
...
public class ArtificialLightningMod {
	...
	@Mod.Instance(MODID)
	public static ArtificialLightningMod instance;
	public ElementsArtificialLightningMod elements = new ElementsArtificialLightningMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsArtificialLightningMod.GuiHandler());
